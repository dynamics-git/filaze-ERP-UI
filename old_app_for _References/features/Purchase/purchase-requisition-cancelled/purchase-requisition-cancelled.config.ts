...
export const PurchaseRequisitionCancelledHeader: HeaderDataConfig = {
    idProp: 'Id',
    ...
    sections: [
  {
    ...
    controls: [
      [
        { type: FormFieldType.TextBox, label: 'Number', name: 'Purchase Requisition No', required: true, disabled: true },
        { type: FormFieldType.TextBox, label: 'ApprovalStatus', name: 'Approval Status', initialValue: 'Open', readonly: true }
      ],
      [
        { type: FormFieldType.DateTime, label: 'RequisitionDate', name: 'Requisition Date', dateOnly: true },
        { type: FormFieldType.Number, label: 'PRApprovedAmount', name: 'PR Approved Amount LCY', decimal: true, required: true, readonly: true }
      ]
    ]
  },
  {
...
PurchaseRequisitionCancelledHeader.controls = (PurchaseRequisitionCancelledHeader.sections ?? []).flatMap(section => section.controls);
export const PurchaseRequisitionCancelledLine: LineDataConfig = {
    idProp: 'Id',
    headerPKProp: 'Number',
