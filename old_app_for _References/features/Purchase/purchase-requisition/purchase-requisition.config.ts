...
export const PurchaseRequisitionListHeaders = [
...
export const PurchaseRequisitionHeader: HeaderDataConfig = {
    idProp: 'Id',
    ...
    sections: [
       ...
       /* Delivery Date */           { type: FormFieldType.DateTime, label: 'DeliveryDate', name: 'Requested Delivery Date', dateOnly: true, defaultSystemDate: true }],
                ...
                [
                    { type: FormFieldType.Checkbox, label: 'isCombinedPr', name: 'Combined PR Created ', readonly: true },
...
PurchaseRequisitionHeader.controls = (PurchaseRequisitionHeader.sections ?? []).flatMap(section => section.controls);


export const PurchaseRequisitionLine: LineDataConfig = {
    idProp: 'Id',
    headerPKProp: 'Number',
...
export const PurchaseRequisitionCalculation: CalculationSectionConfig = {
    controls: [
        [
            {
                type: FormFieldType.Number,
