...
export const PurchaseOrderCancelledHeader: HeaderDataConfig = {
    idProp: 'Id',
...
PurchaseOrderCancelledHeader.controls = (PurchaseOrderCancelledHeader.sections ?? []).flatMap(section => section.controls);
export const PurchaseOrderCancelledLine: LineDataConfig = {
    idProp: 'Id',
    headerPKProp: 'Number',
...
export const PurchaseOrderCancelledCalculation: CalculationSectionConfig = {
    controls: [
        [
            {
                type: FormFieldType.Number,
