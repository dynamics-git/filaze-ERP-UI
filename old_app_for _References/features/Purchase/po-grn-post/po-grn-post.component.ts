...
import { ReadytoGRNHeader, ReadytoGRNLine, ReadytoGRNCalculation } from './po-grn-post.config';
...
export class PoGrnPostComponent implements OnInit {
  ...
  config: DataTableConfig = {
    ...
    addItemConfig: {
      ...
      recordId: "Number",
      recordTitle: "Number",
      headerConfig: ReadytoGRNHeader,
      lineConfig: ReadytoGRNLine,
      calculationSectionConfig: ReadytoGRNCalculation,
      informationSectionConfig: {
        documentNoProp: 'Number',
        documentType: 'Order',
        documentStatusProp: 'Status',
