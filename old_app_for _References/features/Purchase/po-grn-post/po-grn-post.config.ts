...
export const ReadytoGRNHeader: HeaderDataConfig = {
    idProp: 'Id',
...
export const ReadytoGRNLine: LineDataConfig = {
    idProp: 'Id',
    headerPKProp: 'Number',
...
export const ReadytoGRNCalculation: CalculationSectionConfig = {
    controls: [
        [
            {
                type: FormFieldType.Number,
