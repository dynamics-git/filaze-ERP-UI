...
export const PurchaseCreditMemoeHeader: HeaderDataConfig = {
    idProp: 'Id',
    api: '/purchCrMemoHeaders',
    ...
    sections: [
        {
            ...
            controls: [
                [
                    { type: FormFieldType.TextBox, label: 'Number', name: 'Number', required: true, readonly: true },
        ...
        },
        {
            ...
            controls: [
                ...
                [
                    { type: FormFieldType.TextBox, label: 'VendorCrMemoNo', name: 'Vendor Credit Memo No' },
...
PurchaseCreditMemoeHeader.controls = (PurchaseCreditMemoeHeader.sections ?? []).flatMap(section => section.controls);


export const PurchaseCreditMemoLine: LineDataConfig = {
    idProp: 'Id',
    headerPKProp: 'Number',
    lineFKProp: 'DocumentNo',
    api: '/purchCrMemoLines',
...
export const PurchaseCreditMemoCalculation: CalculationSectionConfig = {
    controls: [
        [
            {
                type: FormFieldType.Number,
