...
import { PRVenderSelectionHeader, PRVenderSelectionLine } from './PR-vender-selection.config';
...
@Component({
  standalone: false,
  selector: 'app-pr-vendor-selection',
...
export class PRVendorSelectionComponent {

  config: DataTableConfig = {
    title: 'PR Vendor Selection',
    idProp: 'Id',
    ...
    addItemConfig: {
      ...
      recordId: "Number",
      recordTitle: "Number",
      headerConfig: PRVenderSelectionHeader,
      lineConfig: PRVenderSelectionLine,
