...
export const ApprovedPurchaseRequisitionHeader: HeaderDataConfig = {
    idProp: 'Id',
...
ApprovedPurchaseRequisitionHeader.controls = (ApprovedPurchaseRequisitionHeader.sections ?? []).flatMap(section => section.controls);


export const ApprovedPurchaseRequisitionLine: LineDataConfig = {
    idProp: 'Id',
    headerPKProp: 'Number',
