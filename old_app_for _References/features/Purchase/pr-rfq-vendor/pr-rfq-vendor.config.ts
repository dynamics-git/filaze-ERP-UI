...
export const RFQVenderSelectionHeader: HeaderDataConfig = {
    idProp: 'Id',
    api: '/rfqVendorSelectionHeaders',
...
RFQVenderSelectionHeader.controls = (RFQVenderSelectionHeader.sections ?? []).flatMap(section => section.controls);


export const RFQVenderSelectionLine: LineDataConfig = {
    idProp: 'Id',
    headerPKProp: 'Number',
