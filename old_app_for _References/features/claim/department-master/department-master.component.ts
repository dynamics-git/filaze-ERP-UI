...
import { DepartmentLineConfig } from './department-master.config';
...
export class DepartmentMasterComponent extends LineWorkspacePageBase implements OnInit {

  protected lineDataConfig: LineDataConfig = DepartmentLineConfig;
