...
import { EmployeeRoleLineConfig } from './employee-role-master.config';

@Component({
  standalone: false,
  selector: 'app-employee-role-master',
  template: LINE_WORKSPACE_PAGE_TEMPLATE
})
export class EmployeeRoleMasterComponent extends LineWorkspacePageBase implements OnInit {

  protected lineDataConfig: LineDataConfig = EmployeeRoleLineConfig;
