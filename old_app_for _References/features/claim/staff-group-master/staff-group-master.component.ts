...
import { StaffGroupLineConfig } from './staff-group-master.config';
...
export class StaffGroupMasterComponent extends LineWorkspacePageBase implements OnInit {

  protected lineDataConfig: LineDataConfig = StaffGroupLineConfig;
