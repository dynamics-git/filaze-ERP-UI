...
import { EntitlementsLineConfig } from './entitlements.config';
...
export class EntitlementsComponent extends LineWorkspacePageBase implements OnInit {

  protected lineDataConfig: LineDataConfig = EntitlementsLineConfig;
